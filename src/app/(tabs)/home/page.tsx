...
export default function Home() {
    ...
    return(
        <div className="relative w-full h-full flex flex-col justify-start items-center p-10">
            ...
            {/* Introduction */}
            <div ref={introContainer} className="max-w-[1000px] w-full flex flex-col md:flex-row justify-center md:justify-between items-center gap-5 text-center md:text-left">
                {/* Introduction Text */}
                ...
                {/* Image */}
                <div className="headshot-container relative max-w-[300px] min-w-[200px] aspect-[1/1] w-1/2 p-2 border-t border-b border-highlight/80 rounded-full">
                    <div className="headshot absolute z-10 top-[50%] left-[0%] -translate-x-1/2 -translate-y-1/2 bg-highlight/20 backdrop-blur-xs border border-highlight text-highlight rounded-full p-2">
                        <FileBracesCorner size={20} />
                    </div>
                    <div className="headshot absolute z-10 top-[50%] left-[100%] -translate-x-1/2 -translate-y-1/2 bg-highlight/20 backdrop-blur-xs border border-highlight text-highlight rounded-full p-2">
                        <Computer size={20} />
                    </div>
