...
export default function Home() {
    ...
    return(
        <div className="relative w-full flex flex-col justify-start md:justify-center items-center p-10">
            ...
            {/* Call to action */}
            <div className='job-container opacity-0 -translate-y-5 w-full max-w-[1000px] px-5 py-3 bg-highlight/20 backdrop-blur-xs text-white/80 text-[0.75rem] md:text-[1rem] border border-highlight rounded-md '>
