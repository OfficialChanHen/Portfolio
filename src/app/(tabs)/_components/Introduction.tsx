...
import { Sparkles, FileBracesCorner, Computer, Rocket, Mail, ArrowBigRight } from 'lucide-react';
    ...
    return(
        <div ref={introContainer} className="max-w-[1000px] w-full flex flex-col md:flex-row justify-center md:justify-between items-center gap-10 text-center md:text-left">
            ...
            <div ref={textContainer} className="relative flex flex-col justify-center gap-2">
                ...
                {/* Intro Buttons */}
                <div className='intro-text flex flex-col md:flex-row justify-center md:justify-start items-center mt-3 gap-5 text-[0.7rem] md:text-[1rem]'>
                    <Link href="/projects">
                        <button className="group inline-flex items-center justify-center gap-2 px-5 py-3 rounded-md cursor-pointer text-white tracking-widest transition-[box-shadow] duration-500 bg-primary/40 backdrop-blur-xs border-none shadow-[0_0_25px] shadow-tertiary hover:shadow-[0_0_5px,_0_0_25px,_0_0_50px,_0_0_100px] hover:shadow-tertiary active:scale-[0.97]">
