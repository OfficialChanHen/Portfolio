...
export default function About() {
    ...
    return(
        <div className="w-full h-full flex flex-col justify-start md:justify-center items-center">
            <StarBackground/>
            {/* First page */}
            <div className="min-w-screen min-h-[calc(100vh-64px)] flex flex-col justify-start items-center p-10 gap-10">
                {/* Header Info */}
                <div ref={textContainer} className="relative flex flex-col justify-center items-center text-center gap-2">
                    ...
                    <h2 className="intro-text text-[2.5rem] md:text-[3.5rem]">
                        <span className="bg-gradient-to-r from-highlight via-tertiary to-highlight bg-clip-text text-transparent">
                            Discover
                        </span>{" "}
                        Who I Am
                    </h2>
                ...
                {/* Resume */}
                <div className="flex flex-row justify-center items-center gap-2 px-5 py-3 rounded-md cursor-pointer bg-primary/40 border-none shadow-[0_0_25px] shadow-tertiary backdrop-blur-xs hover:shadow-[0_0_5px,_0_0_25px,_0_0_50px,_0_0_100px] hover:shadow-tertiary hover:scale-105 text-nowrap transition-all ease-in-out duration-500">
